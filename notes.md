...
Полезно, когда во время учёбы невелико количество ненужных (инициированных не нами) отвлечений.

Перерывы нужны. Сначала перерывы предлагаю я, потом запрашивают обучающиеся. Но нужно следить за тем, чтобы раз в час хотя бы какая-то пауза (5-10 минут вполне) была.
...
Хорошей практикой является выделение получаса где-то в начале дня на «разминку»/»врабатывание» — когда ребята пришли, неэффективно неразмятыми мозгами брать новое. Лучше поковырять вчерашнее, что даст и вход в контекст, и поможет закрепить вчерашнее, и подготовит мозги к сегодняшнему, ну и общение запустит.
...
- что такое процесс разработки, фазы и проч
- о том, что нужно замечать успехи и хвалить за них. Да, каждый раз.

В процессе обучения важно, чтобы больше говорили учащиеся, чем учитель.
...
- пара местных ребят, не прошедщих отбор, продолжают со мной общаться, вроде как заинтересованы попробовать снова. Посмотрим, до конца ли пойдут, или же нет.
